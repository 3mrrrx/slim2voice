...
def play_synth(argument):
   ...
   # player 1
   #  if argument == 'w':
   #      return send_freqs_to_synth_0(str(fundamental*pow(2,(1+0+a)/12)))
   #  elif argument in 'a':
   #      return send_freqs_to_synth_0(str(fundamental*pow(2,(3+0+a)/12)))
   #  elif argument == 's':
   #      return send_freqs_to_synth_0(str(fundamental*pow(2,(6+0+a)/12)))
   #  elif argument in 'd':
   #      return send_freqs_to_synth_0(str(fundamental*pow(2,(8+0+a)/12)))
   #  elif argument in 'u':
   #      return send_freqs_to_synth(str(fundamental*pow(2,(9+0+a)/12)))
   #  elif argument in 'i':
   #      return send_freqs_to_synth(str(fundamental*pow(2,(1+12+a)/12)))
   #  elif argument in 'o':
   #      return send_freqs_to_synth(str(fundamental*pow(2,(3+12+a)/12)))
   #  elif argument in 'j':
   #      return send_freqs_to_synth(str(fundamental*pow(2,(6+12+a)/12)))
   #  elif argument == 'k':
   #      return send_freqs_to_synth(str(fundamental*pow(2,(8+12+a)/12)))
   #  elif argument == 'l':
   #      return send_freqs_to_synth(str(fundamental*pow(2,(9+12+a)/12)))
   #  else:
   #      print("input not reference to an OSC letter, input was  " + argument)
